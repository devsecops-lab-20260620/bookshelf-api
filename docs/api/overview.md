...
家庭内の書籍を管理するための REST API 仕様をまとめます。対象は、書籍情報の登録・閲覧・更新・削除、管理する人の登録・閲覧・更新・削除、人のログイン・ログアウト、ヘルスチェックです。
...
書籍を管理する人の情報です。想定する主な属性は次のとおりです。
...
ログインは人の認証情報を受け取り、以後の API 呼び出しで使うトークンを返します。ログアウトは現在の認証状態を終了します。
